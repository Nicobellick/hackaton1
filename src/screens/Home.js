...
<div className='choixUser'>
    ...
    <div id="info_soleil" className="titre_info">Love Room</div>
    <div id="cadre_soleil">
        <h2>Bienvenue dans la LoveRoom, soyez prêt à affronter la température  (Les Ewok ainsi que toutes formes de mammifaires poilu sonts fortement apprécié)</h2>
    </div>
    
    <div id="info_lune" className="titre_info">Seduce MasterClass</div>
    <div id="cadre_lune">
        <h2>Affronte ton/ta/tes partenaire(s) et fait en sorte de pénétrer l'atmosphère de l'amour</h2>
    </div>
    
    <div id="info_ceinture_asteroides" className="titre_info">Compatibilité Intergalactique</div>
    <div id="cadre_ceinture_asteroides">
        <h2>Tu as croisés l'élu de tes poils et tu souhaites tester vos prochaines 43secondes* ensemble ? C'est ici que ca se passe !</h2>
        <p>(* Durée de performances par variété d'espece observé depuis le siecle dernier)</p>
    </div>

</div>

    <div id="info_mercure" className="titre_info"></div>
    <div id="cadre_mercure">
...
--> */}
    ...
    <div id="mercure" className="orbite">
        <div id="planete_mercure">
        </div>
    </div>
    
    <div id="venus" className="orbite">
        <div id="planete_venus">
        </div>
    </div>
    ...
    <div id="uranus" className="orbite">
        <div id="planete_uranus">
            <div id="anneau_uranus">
            </div>
        </div>
    </div>
    
    <div id="neptune" className="orbite">
        <div id="planete_neptune">
        </div>
    </div>
